...
function EducationPage() {
  ...
  // Load kategori sekali saat mount
  useEffect(() => {
  ...
  // Load artikel setiap filter/pagination berubah
  useEffect(() => {
              ...
              style={{
                ...
                border:
                  selectedCategory === null
                    ...
                    : "2px solid #dee2e6",
                background:
                  selectedCategory === null ? "#4e73df" : "white",
                color:
                  selectedCategory === null ? "white" : "#495057",
                cursor: "pointer",
                fontWeight: 500,
                transition: "all 0.3s",
              }}
...
// Article Card Component (tidak berubah)

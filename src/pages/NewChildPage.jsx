...
function NewChildPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect ke dashboard atau halaman anak
      navigate("/children");
    } catch (err) {
      ...
      if (err.response?.status === 422 && err.response.data?.errors) {
        ...
        setError("Gagal menyimpan data anak. Coba lagi.");
      }
    } finally {
      setLoading(false);
    }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: 0, marginBottom: "1.5rem", color: "#6b7280", fontSize: 14 }}>
            ...
            <div style={{ marginBottom: "1rem" }}>
              ...
              <select
                ...
                style={{
                  ...
                  padding: "10px 12px",
                  borderRadius: 8,
                  border: fieldErrors.gender ? "2px solid #f87171" : "1px solid #d1d5db",
                  fontSize: 14,
                  outline: "none",
                  background: "white",
                }}
